        ...
        <div className="p-6 bg-gray-900 border border-gray-800 rounded-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input {...register('base_price')} type="text" placeholder="Ex: 29,90" className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500" />
            ...
            <div>
              ...
              <input {...register('puffs')} placeholder="Ex: 8000" className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500" />
            </div>
